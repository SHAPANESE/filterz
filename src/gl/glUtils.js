...
// Upload an image source (ImageBitmap/Canvas/Image) into a texture.
// With this quad + FBO ping-pong pipeline, the net result is upright WITHOUT
// a Y-flip on upload (flipping here renders the final image upside down).
